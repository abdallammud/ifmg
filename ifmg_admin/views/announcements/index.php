<div class="space-y-8">
    <div class="flex items-center justify-between">
        <div>
            <h1 class="text-3xl font-bold text-navy-900 tracking-tight">Announcements</h1>
            <p class="text-gray-500 mt-1 font-medium">Manage public notices, vacancies, and tenders.</p>
        </div>
        <a href="<?php echo url('announcements/create'); ?>"
    ...
    <?php echo UI::card("All Announcements", UI::table(
        ['Announcement', 'Date', 'Status', 'Actions'],
        array_map(function ($a) {
                $statusBadge = UI::badge($a['status'], $a['status'] == 'open' ? 'success' : ($a['status'] == 'closed' ? 'error' : 'info'));
                return [
